...
const PROJECTS = [
  { title: "Teen Mental Health Analysis", color: "#10b981", LIcon: Brain, description: "Machine Learning analysis of social media impact on teen mental health using Logistic Regression & Random Forest. Includes EDA and feature engineering.", tech: ["Python", "Pandas", "NumPy", "Scikit-learn", "Matplotlib", "Machine Learning", "Logistic Regression", "Random Forest"], link: null , github: "https://github.com/abdullahmufeezz/PITP_FinalProject-Social-Media-Impact-on-Teens-Mental-Health-" },
  { title: "Student Performance Analyzer", color: "#66FF00", LIcon: GraduationCap, description: "A predictive analytics project that estimates student exam scores using machine learning.", tech: ["Python", "Random Forest Regressor", "Machine Learning", "Pandas", "NumPy", "Scikit-Learn"], link: "https://student-analysis-model-lezc.vercel.app/" , github: "https://github.com/abdullahmufeezz/Student_Performance_Analysis" },
